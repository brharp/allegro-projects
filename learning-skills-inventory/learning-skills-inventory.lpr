;; -*- lisp-version: "9.0 [Windows] (Sep 16, 2013 19:23)"; cg: "9.0"; -*-
...
(define-project :name :learning-skills-inventory
  :modules (list (make-instance 'module :name "forms")
                 ...
                 (make-instance 'module :name "rank-responses")
                 (make-instance 'module :name "count-responses")
                 (make-instance 'module :name "weighted-average")
                 (make-instance 'module :name "f_survey")
                 (make-instance 'module :name "print-question")
                 (make-instance 'module :name "read-response"))
  :projects nil
  :libraries nil
  :editable-files nil
